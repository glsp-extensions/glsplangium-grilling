...
export interface Relation extends AstNode {
    readonly $type: 'Abstraction' | 'Association' | 'Dependency' | 'Generalization' | 'InterfaceRealization' | 'PackageImport' | 'PackageMerge' | 'Realization' | 'Relation' | 'Substitution' | 'Usage';
    __id: string
