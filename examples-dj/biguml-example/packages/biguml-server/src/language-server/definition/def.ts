...
import { astType, crossReference, noBounds, path, root, withDefaults } from 'generator-langium-model-management';
...
//custom
//min und max
//kleinste funktionsblocke, die man dann spater (@node(default:true))
@withDefaults
