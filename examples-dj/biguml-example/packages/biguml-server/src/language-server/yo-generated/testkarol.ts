[
    ...
    },
    {
        ...
        decorators: [],
        properties: [],
        extends: ['ElementWithSizeAndPosition'],
        name: 'Entity'
    },
    {
        type: 'class',
        ...
        properties: [
            {
                name: 'name',
                isOptional: false,
                decorators: ['LengthBetween:3,10,{ message: "Enumeration.name must be 3–10 characters" }'],
                types: [
                    {
                        type: 'simple',
                        typeName: 'string'
    ...
    },
    {
        type: 'class',
        isAbstract: false,
        decorators: ['noBounds', 'withDefaults'],
        properties: [
            {
                name: 'name',
                isOptional: false,
        ...
        properties: [
            {
                name: 'name',
                isOptional: false,
                decorators: ['MinLength:5,{ message: "Class.name must be at least 5 characters long" }'],
                types: [
                    {
                        type: 'simple',
                        typeName: 'string'
            ...
            },
            {
                name: 'temp',
                isOptional: true,
                decorators: ['Equals:false,{ message: "temp must be true in this profile." }'],
                types: [
                    {
                        type: 'simple',
                        typeName: 'boolean'
        ...
        properties: [
            {
                name: 'name',
                isOptional: false,
                decorators: ['LengthBetween:3,10,{ message: "Interface.name must be 3–10 characters" }'],
                types: [
                    {
                        type: 'simple',
                        typeName: 'string'
    ...
    },
    {
        ...
        properties: [
            ...
            },
            {
                name: 'propertyType',
                isOptional: true,
                decorators: ['dynamicProperty:DataType', 'crossReference'],
                types: [
                    {
                        type: 'complex',
    ...
    },
    {
        ...
        properties: [
            ...
            },
            {
                ...
                isOptional: true,
                decorators: ['dynamicProperty:DefiningFeature', 'crossReference'],
                types: [
                    {
                        type: 'complex',
    ...
    },
    {
        type: 'class',
        isAbstract: false,
        decorators: ['withDefaults', 'astType:Association'],
        properties: [
            {
                name: 'name',
                isOptional: true,
