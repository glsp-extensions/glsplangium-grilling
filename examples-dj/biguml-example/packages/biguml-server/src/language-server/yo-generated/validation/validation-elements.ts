...
export class EnumerationValidationElement {
    constructor(src: Enumeration) { Object.assign(this, src); }
...
export class ClassValidationElement {
    constructor(src: Class) { Object.assign(this, src); }
...
export class InterfaceValidationElement {
    constructor(src: Interface) { Object.assign(this, src); }
...
export class DataTypeValidationElement {
    constructor(src: DataType) { Object.assign(this, src); }
