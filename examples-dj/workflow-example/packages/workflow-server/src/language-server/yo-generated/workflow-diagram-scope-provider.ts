...
import { PackageAstNodeDescription, PackageExternalAstNodeDescription } from './workflow-diagram-scope.js';
...
export class PackageScopeProvider extends DefaultScopeProvider {
   constructor(protected services: WorkflowDiagramServices, protected packageManager = services.shared.workspace.PackageManager) {
      super(services);
   }
...
export class WorkflowDiagramScopeProvider extends PackageScopeProvider {}