import * as langium_gen from 'generator-langium-model-management';
import {
    AstNode,
    AstNodeLocator,
    CstNode,
...
interface IntermediateReference {
    $refText?: string;
    $ref?: langium_gen.Reference<AstNode>;
    $error?: string;
}
...
export class UmlJsonSerializer implements JsonSerializer {
    ...
    protected getRefNode<T extends AstNode>(root: AstNode, ref: langium_gen.Reference<T>): AstNode {
