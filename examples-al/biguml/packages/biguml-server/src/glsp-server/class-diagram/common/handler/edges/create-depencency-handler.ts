...
import { Dependency, RelationType } from '../../../../../language-server/generated/ast.js';
...
@injectable()
export class CreateDependencyOperationHandler extends CreateClassDiagramEdgeOperationHandler {
    override elementTypeIds = [ModelTypes.DEPENDENCY];

    override label = 'Dependency';
