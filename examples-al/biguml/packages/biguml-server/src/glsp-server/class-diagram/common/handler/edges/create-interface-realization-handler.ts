...
import { InterfaceRealization, RelationType } from '../../../../../language-server/generated/ast.js';
...
@injectable()
export class CreateInterfaceRealizationOperationHandler extends CreateClassDiagramEdgeOperationHandler {
    override elementTypeIds = [ModelTypes.INTERFACE_REALIZATION];

    override label = 'InterfaceRealization';
