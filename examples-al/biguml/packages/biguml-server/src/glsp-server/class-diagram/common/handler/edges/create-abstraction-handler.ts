...
import { Abstraction, RelationType } from '../../../../../language-server/generated/ast.js';
...
@injectable()
export class CreateAbstractionOperationHandler extends CreateClassDiagramEdgeOperationHandler {
    override elementTypeIds = [ModelTypes.ABSTRACTION];

    override label = 'Abstraction';
